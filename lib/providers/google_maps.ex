...
# Upstream: https://framagit.org/framasoft/mobilizon/-/blob/main/lib/service/geospatial/google_maps.ex

defmodule Geospatial.Providers.GoogleMaps do
  @moduledoc """
  ...
  @impl Provider
  @doc """
  Google Maps implementation for `c:Geospatial.Providers.Provider.geocode/3`.
  """
  ...
  @impl Provider
  @doc """
  Google Maps implementation for `c:Geospatial.Providers.Provider.search/2`.
  """
  ...
  defp fetch_place_details do
    (Application.get_env(:geospatial, __MODULE__)
